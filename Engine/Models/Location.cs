...
namespace Engine.Models
{
    public class Location
    {
        ...
        public List<Attunement> AttunementAvailableHere { get; } = new List<Attunement>();
        ...
        public Location(int xCoordinate, int yCoordinate, string name, string description, string imageName, Attunement attunement)
        {
